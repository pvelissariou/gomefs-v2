...
foreach y ( 0020 )
    ...
    setenv FOR021A ${D}/archMN.${y}_mlt.a
    setenv FOR021  ${D}/archMN.${y}_mlt.b
    setenv FOR022A ${D}/archMN.${y}_3di.a
    setenv FOR022  ${D}/archMN.${y}_3di.b
    setenv FOR033A ${D}/archMN.${y}_3zt.a
    setenv FOR033  ${D}/archMN.${y}_3zt.b
    setenv FOR034A ${D}/archMN.${y}_3zs.a
    setenv FOR034  ${D}/archMN.${y}_3zs.b
    setenv FOR035A ${D}/archMN.${y}_3zr.a
    setenv FOR035  ${D}/archMN.${y}_3zr.b
    setenv FOR037A ${D}/archMN.${y}_3zu.a
    setenv FOR037  ${D}/archMN.${y}_3zu.b
    setenv FOR038A ${D}/archMN.${y}_3zv.a
    setenv FOR038  ${D}/archMN.${y}_3zv.b
    setenv FOR039A ${D}/archMN.${y}_3zw.a
    setenv FOR039  ${D}/archMN.${y}_3zw.b
    setenv FOR040A ${D}/archMN.${y}_3zi.a
    setenv FOR040  ${D}/archMN.${y}_3zi.b
    setenv FOR041A ${D}/archMN.${y}_3zk.a
    setenv FOR041  ${D}/archMN.${y}_3zk.b
