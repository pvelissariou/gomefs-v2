...
foreach y ( 0020 )
    ...
    setenv CDF021  ${D}/archMN.${y}_mlt.nc
    setenv CDF022  ${D}/archMN.${y}_3di.nc
    setenv CDF033  ${D}/archMN.${y}_3zt.nc
    setenv CDF034  ${D}/archMN.${y}_3zs.nc
    setenv CDF035  ${D}/archMN.${y}_3zr.nc
    setenv CDF037  ${D}/archMN.${y}_3zu.nc
    setenv CDF038  ${D}/archMN.${y}_3zv.nc
    setenv CDF039  ${D}/archMN.${y}_3zc.nc
    setenv CDF040  ${D}/archMN.${y}_3zw.nc
    setenv CDF041  ${D}/archMN.${y}_3zi.nc
    setenv CDF042  ${D}/archMN.${y}_3zk.nc
    /bin/rm $CDF051  $CDF021  $CDF022
    /bin/rm $CDF033  $CDF034  $CDF035  $CDF037  $CDF038  $CDF039
    /bin/rm $CDF040  $CDF041  $CDF042
...
5500.0	'z     ' = sample depth 33
 ...
 -22	'infio ' = intf. depth I/O unit (0 no I/O, <0 label with layer #)
  ...
  42	'keio  ' = kinetic egy I/O unit (0 no I/O)
E-o-D
end
