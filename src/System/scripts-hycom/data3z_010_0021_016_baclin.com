...
foreach y ( 0021 )
  foreach d ( 016 )
    ...
    setenv FOR037A ${D}/archv.${y}_${d}_00_3zub.a
    setenv FOR037  ${D}/archv.${y}_${d}_00_3zub.b
    setenv FOR038A ${D}/archv.${y}_${d}_00_3zvb.a
    setenv FOR038  ${D}/archv.${y}_${d}_00_3zvb.b
    setenv FOR040A ${D}/archv.${y}_${d}_00_3zcb.a
    setenv FOR040  ${D}/archv.${y}_${d}_00_3zcb.b
...
####
###    foreach t ( bot mlt 3di 3zt 3zs 3zr 3zub 3zvb 3zcb 3zw )
