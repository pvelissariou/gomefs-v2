...
# --- z-levels are at Levitus depths.
#
# --- output is netCDF.
...
#
foreach y ( 0020 )
    setenv CDF021  ${D}/archMN.${y}_SFi.nc
    setenv CDF022  ${D}/archMN.${y}_SFl.nc
    setenv CDF023  ${D}/archMN.${y}_SFz.nc
    /bin/rm $CDF021  $CDF022  $CDF023
    ../../ALL/archive/src/archv2ncdfsfl <<E-o-D
${D}/archMN.${y}.a
netCDF
 ...
 -32.0	'latmin' = minimum latitude to sample (degN)
  66.0	'latmax' = maximum latitude to sample (degN)
   4.0	'latcel' = latitude cell size
