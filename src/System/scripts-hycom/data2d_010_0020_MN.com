...
set echo
#
# --- extract 2-d fields from a single HYCOM mean archive file.
...
foreach y ( 0020 )
    ...
    setenv FOR021A ${D}/archMN.${y}_flx.a
    setenv FOR021  ${D}/archMN.${y}_flx.b
    setenv FOR022A ${D}/archMN.${y}_ice.a
    setenv FOR022  ${D}/archMN.${y}_ice.b
    setenv FOR023A ${D}/archMN.${y}_fsd.a
    setenv FOR023  ${D}/archMN.${y}_fsd.b
    setenv FOR024A ${D}/archMN.${y}_mix.a
    setenv FOR024  ${D}/archMN.${y}_mix.b
    setenv FOR025A ${D}/archMN.${y}_bke.a
    setenv FOR025  ${D}/archMN.${y}_bke.b
    setenv FOR031A ${D}/archMN.${y}_3di.a
    setenv FOR031  ${D}/archMN.${y}_3di.b
    setenv FOR032A ${D}/archMN.${y}_3dh.a
    setenv FOR032  ${D}/archMN.${y}_3dh.b
    setenv FOR033A ${D}/archMN.${y}_3dt.a
    setenv FOR033  ${D}/archMN.${y}_3dt.b
    setenv FOR034A ${D}/archMN.${y}_3ds.a
    setenv FOR034  ${D}/archMN.${y}_3ds.b
    setenv FOR035A ${D}/archMN.${y}_3dr.a
    setenv FOR035  ${D}/archMN.${y}_3dr.b
    setenv FOR036A ${D}/archMN.${y}_3dn.a
    setenv FOR036  ${D}/archMN.${y}_3dn.b
    setenv FOR037A ${D}/archMN.${y}_3du.a
    setenv FOR037  ${D}/archMN.${y}_3du.b
    setenv FOR038A ${D}/archMN.${y}_3dv.a
    setenv FOR038  ${D}/archMN.${y}_3dv.b
    setenv FOR039A ${D}/archMN.${y}_3dc.a
    setenv FOR039  ${D}/archMN.${y}_3dc.b
    setenv FOR040A ${D}/archMN.${y}_3dw.a
    setenv FOR040  ${D}/archMN.${y}_3dw.b
    setenv FOR041A ${D}/archMN.${y}_3dk.a
    setenv FOR041  ${D}/archMN.${y}_3dk.b
    /bin/rm $FOR051
    /bin/rm $FOR051A
...
000	'iexpt ' = experiment number x10 (000=from archive file)
 ...
 40	'wvlio ' = layer k   w-vel. I/O unit (0 no I/O)
...
#
    foreach t ( bot flx ice fsd mix bke 3di 3dh 3dt 3ds 3dr 3dn 3du 3dv 3dw 3dm 3dk )
