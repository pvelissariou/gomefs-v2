...
;
; PURPOSE:
;	Interpolate from field at rho points to a field at psi points.
;
; AUTHOR:
;
...
;
; CALLING SEQUENCE:
;	  outData = Rho2P(data [, mask] [, keywords])
...
;
; RETURNS:
;         outData - The 2D/3D array of the variable calculated at PSI
...
;+++
FUNCTION Rho2P, data, mask, MASK_VAL = mask_val
  ...
  case nDIMS of
    2: $
      begin
        ...
        inpData = Rho2UVP_Points(inpData, /PLOC)
