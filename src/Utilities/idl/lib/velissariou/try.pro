...
; CALLING SEQUENCE:
;	  outData = VL_Obs2StdZ(data, obslevs, stdlevs [, depth] [, keywords])
...
;       MASK_VAL - Set this variable to a value to be used as a mask
;                  for missing data
;
; RETURNS:
...
;+++
FUNCTION Try, Data, ObsLevs, StdLevs, Depth, $
              REINIGER = reiniger, $
              REVERSE  = reverse,  $
              MASK_VAL = mask_val
