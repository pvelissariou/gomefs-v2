...
;
; PURPOSE:
;	To calculate the maximum Beckman & Haidvogel (rx0) grid stiffness parameter.
;       The rx0 calculated values represent the maximum value of rx0
...
;                   (THAT IS AT THE RHO-POINTS). The size of the zarr should be:
;                   Size: zarr[IPNTS, JPNTS, NLAY].
...
;                   values of the Beckman & Haidvogel stiffness parameter for each layer.
...
;                   the Beckman & Haidvogel stiffness parameter.
...
;+++
  ...
  If (KPNTS NE n_lay) Then $
    Message, "The vertical dimension of <zarr> is not equal to nlay."
