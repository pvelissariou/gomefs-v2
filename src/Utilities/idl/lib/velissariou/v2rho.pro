...
;
; PURPOSE:
;	Interpolate from field at v points to a field at rho points.
;
; AUTHOR:
;
...
;
; CALLING SEQUENCE:
;	  outData = V2Rho(data [, mask] [, keywords])
;	     data - The 2D/3D array of the variable values at v points
...
;+++
FUNCTION V2Rho, data, mask, MASK_VAL = mask_val
  ...
  case nDIMS of
    2: $
      begin
        ...
        inpData = UVP2Rho_Points(inpData, /VLOC)
