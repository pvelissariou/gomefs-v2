...
;
; PURPOSE:
;	Interpolate from field at rho points to a field at v points.
;
; AUTHOR:
;
...
;
; CALLING SEQUENCE:
;	  outData = Rho2V(data [, mask] [, keywords])
...
;
; RETURNS:
;         outData - The 2D/3D array of the variable calculated at V
...
;+++
FUNCTION Rho2V, data, mask, MASK_VAL = mask_val
  ...
  case nDIMS of
    2: $
      begin
        ...
        inpData = Rho2UVP_Points(inpData, /VLOC)
