...
;
; PURPOSE:
;	Interpolate from field at u points to a field at rho points.
;
; AUTHOR:
;
...
;
; CALLING SEQUENCE:
;	  outData = U2Rho(data [, mask] [, keywords])
;	     data - The 2D/3D array of the variable values at u points
...
;+++
FUNCTION U2Rho, data, mask, MASK_VAL = mask_val
  ...
  case nDIMS of
    2: $
      begin
        ...
        inpData = UVP2Rho_Points(inpData, /ULOC)
