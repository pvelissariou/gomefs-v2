...
# Original template was copied from the ROMS model directory            :::
...
mods_src := mod_dimensions.F mod_xc.F mod_za.F mod_cb_arrays.F mod_pipe.F \
	    mod_incupd.F                                                  \
	    mod_floats.F mod_stokes.F mod_tides.F mod_mean.F mod_archiv.F \
	    mod_tsadvc.F mod_momtum.F                                     \
	    mod_hycom.F
...
obj_src := barotp.F bigrid.F blkdat.F cnuity.F convec.F           \
	   ...
	   matinv.F mxkprf.F mxkrt.F mxkrtm.F mxpwp.F             \
