c-----------------------------------------------------------------------------
     ...
     & thkk           ! virtual potential density in bottom layer
      ...
      common/hycom1r/ u,v,dp,dpo,dpu,dpv,p,pu,pv,
...
c
     ...
     &                depthu,depthv,pvtrop,depths,drag,dragrh,salfac,
     &                topiso,diwbot,diwqh0,sssrmx
      save  /hycom3r/
c
      real, dimension (1-nbdy:idm+nbdy,1-nbdy:jdm+nbdy) ::
...
c --- 'lbflag' = lateral baro. bndy flag (0=none;1,3=port;2,4=nest;3,4=flather)
...
c
     ...
     &               sigjmp,tmljmp,salmin(kdm)
      save  /parms1r/
c
      integer        tsofrq,mixfrq,icefrq,icpfrq,nhybrd,nsigma,
     ...
     &               difsmo
      common/parms1i/tsofrq,mixfrq,icefrq,icpfrq,nhybrd,nsigma,
     &               hybmap,hybflg,advflg,advtyp,momtyp,
     &               kapref,kapnum,
     &               ntracr,trcflg,
     &               clmflg,dypflg,iniflg,lbflag,mapflg,yrflag,sshflg,
