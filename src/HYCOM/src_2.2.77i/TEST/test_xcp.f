...
c
      ...
      atile(:,:) = 0.0
      if     (mnproc.eq.1) then
        write(6,'(a,3i5,2x,2i2)') 'xclput - ',nl,i1,j1,1,0
      endif
      call xclput(aline,nl, atile, i1,j1,1,0)
      call nozero(atile)
...
c
      ...
      atile(:,:) = 0.0
      if     (mnproc.eq.1) then
        write(6,'(a,3i5,2x,2i2)') 'xclput - ',nl,i1,j1,0,1
      endif
      call xclput(aline,nl, atile, i1,j1,0,1)
      call nozero(atile)
      call xcsync(flush_lp)
c
