...
c
c     test xclget and xciget.
c
      integer i,ix,j,ksea,nrecl
     ...
     &        atij(2*itdm+2*jtdm)
      integer   ia(2*itdm+2*jtdm),ja(2*itdm+2*jtdm)
c
...
c
      call xclget(ati,40, atile,itdm/2,jtdm/2-20,0,+1, 0)
      call xxlget(aoi,40, aorig,itdm/2,jtdm/2-20,0,+1)
      if     (mnproc.eq.1) then
      write(lp,*) 'call xclget(ati,40, atile, itdm/2,jtdm/2-20,0,+1)'
      endif
      call yycomp(aoi,ati,40)
      if     (mnproc.eq.1) then
      call flush(lp)
      endif
c
...
c
      call xclget(atj,40, atile,itdm/2-20,jtdm/2,+1,0, 0)
      call xxlget(aoj,40, aorig,itdm/2-20,jtdm/2,+1,0)
      if     (mnproc.eq.1) then
      write(lp,*) 'call xclget(atj,40, atile, itdm/2-20,jtdm/2,+1,0)'
      endif
      call yycomp(aoj,atj,40)
      if     (mnproc.eq.1) then
      call flush(lp)
      endif
c
...
c
      call xclget(atj,40, atile,itdm/2+20,jtdm/2+20,-1,-1, 0)
      call xxlget(aoj,40, aorig,itdm/2+20,jtdm/2+20,-1,-1)
      if     (mnproc.eq.1) then
      write(lp,*) 
     & 'call xclget(atj,40, atile, itdm/2+20,jtdm/2+20,-1,-1)'
      endif
      call yycomp(aoj,atj,40)
      if     (mnproc.eq.1) then
      call flush(lp)
...
c
      do i= 1,jtdm
        ...
        ja(i) = i
      enddo
      call xciget(ati,jtdm, atile,ia,ja, 0)
      call xxlget(aoi,jtdm, aorig,itdm/2,1,0,+1)
      if     (mnproc.eq.1) then
      write(lp,*) 'call xciget(ati,jtdm, atile, itdm/2,1,0,+1)'
      endif
      call yycomp(aoi,ati,jtdm)
      if     (mnproc.eq.1) then
      call flush(lp)
...
c
      do i= 1,40
        ...
        ja(i) = jtdm/2-20-1+i
      enddo
      call xciget(ati,40, atile,ia,ja, 0)
      call xxlget(aoi,40, aorig,itdm/2,jtdm/2-20,0,+1)
      if     (mnproc.eq.1) then
      write(lp,*) 'call xciget(ati,40, atile, itdm/2,jtdm/2-20,0,+1)'
      endif
      call yycomp(aoi,ati,40)
      if     (mnproc.eq.1) then
      call flush(lp)
...
c
      ...
      call xxlget(aoi,jtdm, aorig,itdm/2,jtdm,0,-1)
      if     (mnproc.eq.1) then
      write(lp,*) 'call xciget(ati,jtdm, atile, itdm/2,jtdm,0,-1)'
      endif
      call yycomp(aoi,ati,jtdm)
      if     (mnproc.eq.1) then
      call flush(lp)
...
c
      do i= 1,itdm
        ...
        ja(i) = jtdm/2
      enddo
      call xciget(atj,itdm, atile,ia,ja, 0)
      call xxlget(aoj,itdm, aorig,1,jtdm/2,+1,0)
      if     (mnproc.eq.1) then
      write(lp,*) 'call xciget(atj,itdm, atile, 1,jtdm/2,+1,0)'
      endif
      call yycomp(aoj,atj,itdm)
      if     (mnproc.eq.1) then
      call flush(lp)
...
c
      do i= 1,40
        ...
        ja(i) = jtdm/2
      enddo
      call xciget(atj,40, atile,ia,ja, 0)
      call xxlget(aoj,40, aorig,itdm/2-20,jtdm/2,+1,0)
      if     (mnproc.eq.1) then
      write(lp,*) 'call xciget(atj,40, atile, itdm/2-20,jtdm/2,+1,0)'
      endif
      call yycomp(aoj,atj,40)
      if     (mnproc.eq.1) then
      call flush(lp)
...
c
      ...
      call xxlget(aoj,itdm, aorig,itdm,jtdm/2,-1,0)
      if     (mnproc.eq.1) then
      write(lp,*) 'call xciget(atj,itdm, atile, itdm,jtdm/2,-1,0)'
      endif
      call yycomp(aoj,atj,itdm)
      if     (mnproc.eq.1) then
      call flush(lp)
...
c
      ...
      if     (mnproc.eq.1) then
      write(lp,*) 
     & 'call xciget(atj,40, atile, itdm/2+20,jtdm/2+20,-1,-1)'
      endif
      call yycomp(aoj,atj,40)
      if     (mnproc.eq.1) then
      call flush(lp)
...
c
      ...
      enddo
      ix = ix + itdm
      call xciget(atij,ix, atile,ia,ja, 0)
c
      if     (mnproc.eq.1) then
      write(lp,*) 'call XCIGET(ati,jtdm, atile, itdm/2,1,0,+1)'
      endif
...
c
      ...
      ix = ix + jtdm
      call xxlget(aoj,itdm, aorig,1,jtdm/2,+1,0)
      call yycomp(aoj,atij(ix),jtdm)
      if     (mnproc.eq.1) then
      call flush(lp)
      endif
c
      if     (mnproc.eq.1) then
      write(lp,*) 'call XCIGET(ati,jtdm, atile, itdm/2-5,1,0,+1)'
      endif
      ix = ix + itdm
      call xxlget(aoi,jtdm, aorig,itdm/2-5,1,0,+1)
      call yycomp(aoi,atij(ix),jtdm)
      if     (mnproc.eq.1) then
      call flush(lp)
      endif
c
      if     (mnproc.eq.1) then
      write(lp,*) 'call XCIGET(atj,itdm, atile, 1,jtdm/2-5,+1,0)'
      endif
      ix = ix + jtdm
      call xxlget(aoj,itdm, aorig,1,jtdm/2-5,+1,0)
      call yycomp(aoj,atij(ix),jtdm)
      if     (mnproc.eq.1) then
      call flush(lp)
      endif
