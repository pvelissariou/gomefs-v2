...
#      setenv W     /u/home/metzger/force/climo_extend/nogaps0.5a/pcip/
#      setenv W      /p/cwfs/dsfrank/force/climo_extend/nogaps0.5a/pcip/
#      setenv W     /p/cwfs/dsfrank/force/climo_extend/navgem0.5a/pcip
      setenv W     /scr/ooc/data/hycom/preproc/force/navgem/1.2_0.5a/3hrly/climo_extend/pcip
    else
#                  Single Disk
      setenv S ~/$P/SCRATCH
      setenv W ~/flux_ieee/$N
...
touch  fort.70
if (-z fort.70) then
#  ${pget} /u/home/metzger/force/coamps0.2a/cen_amer/coamps_cenamer_lndsea_301x161.D fort.70 &
#  ${pget} /u/home/metzger/mask_ieee/fnmoc/nogaps_mask_360x181.D fort.70 &
  ${pget} /u/home/metzger/force/${N}/navgem_0.5deg_applicagrid_mask_720x361.D fort.70 &
endif
C
...
#  touch  fort.${N}
#  if (-z fort.${N}) then
#      ${pget} ${W2}/3hourly/navgem0.5a-std_${y}_03hr_ttlpcp.D fort.${N} &
#  endif
#end
#
#real time
...
touch  fort.71 fort.72
if (-z fort.71) then
#  ${pget} $W/nogaps0.5a_ttlpcp.D fort.71  &
  /bin/cp $W/navgem0.5a_ttlpcp.D fort.71  &
endif
if (-z fort.72) then
#  ${pget} $W/nogaps0.5a-std_clim_ttlpcp.D fort.72  &
  /bin/cp $W/navgem0.5a-std_clim_ttlpcp.D fort.72  &
endif
C
C --- executable
C
...
cat <<E-o-D  > fort.05i
 &AFTITL
  ...
  CTITLE = 'NAVGEM 0.5a, 3-hrly, sea-only, MKS',
 /
 &AFTIME
...
C
  ...
  /bin/mv precip_${idtg}.B fort.20
  /bin/mv precip_${idtg}.A fort.20A
C
  setenv Q gpcpQfnmoc
 ...
 /
'E-o-D'
  mv fort.10  precip_${idtg}.b
  mv fort.10A precip_${idtg}.a
  /bin/rm -f fort.20 fort.20A fort.30A
endif
#
#set sizefl=`ls -la precip_${idtg}.a | awk '{print $5}'`
#echo ${E} GOMl0.04 ${sizefl} >! ~/${P}/wrongforcing.txt
#if ( ${sizefl} != '83312640' ) then
# mail -s 'SMALL PRECIP FILE ' ${user} < ~/${P}/wrongforcing.txt
#endif
C
if (-e ./SAVE) then
